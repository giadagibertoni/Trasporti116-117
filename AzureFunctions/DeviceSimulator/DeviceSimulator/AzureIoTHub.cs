...
namespace DeviceSimulator
{
    ...
    {
        private const string iotHubConnectionString = "HostName=IoTHub116117.azure-devices.net;SharedAccessKeyName=iothubowner;SharedAccessKey=ajHdtr2d6QRliDGnpSe/FR/RVUWrM8fKjE5P12DpcaY=";

        private const string deviceConnectionString = "HostName=IoTHub116117.azure-devices.net;DeviceId=Ambulance1111;SharedAccessKey=LR+KxhMuO1lW4LbMiyjpTawtrhdiboC/FnzK9i1rtV0=";
