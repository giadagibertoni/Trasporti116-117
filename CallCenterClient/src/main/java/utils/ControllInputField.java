...
public final class ControllInputField {
    private ControllInputField() { }
    ...
    public static final Pattern CITY_PATTERN = Pattern.compile("[a-zA-Z\\s]*");
    public static final Pattern ADDRESS_PATTERN = Pattern.compile("[a-zA-Z0-9\\s]*");
    public static final Pattern DISTRICT_PATTERN = Pattern.compile("[a-zA-Z][a-zA-Z]");
    public static final Pattern NUMBER_PATTERN = Pattern.compile("[0-9]*");
    public static final Pattern FISCAL_CODE = Pattern.compile("^([A-Za-z]{6}[0-9]{2}[A-Za-z]{1}[0-9]{2}[A-Za-z]{1}[0-9]{3}[[A-Za-z]]{1})$|([0-9]{11})$");

    public static final Pattern POSTALCODE_NUMBER_PATTERN = Pattern.compile("[0-9]{5}");

    public static void validate(final Pattern pattern, final TextField input) {
